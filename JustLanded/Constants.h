...
extern NSString * const LOCATION_DISABLED_ANCHOR;
extern NSString * const LOCATION_DENIED_ANCHOR;
extern NSString * const LOCATION_RESTRICTED_ANCHOR;
extern NSString * const PUSH_DISALLOWED_ANCHOR;
...
extern NSString * const HOCKEY_APP_ID_PRODUCTION;
extern NSString * const HOCKEY_APP_ID_ADHOC;
...
extern NSString * const FY_PROMPTED_TO_SEND_ARRIVAL_SMS;
extern NSString * const FY_NOTIFIED_TO_SEND_ARRIVAL_SMS;
extern NSString * const FY_IGNORED_ARRIVAL_SMS_PROMPT;

...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    #else
        NSString * const JL_HOST_NAME = @"pool-74-102-213-44.nwrknj.fios.verizon.net";
        NSString * const WEB_HOST = @"http://pool-74-102-213-44.nwrknj.fios.verizon.net:8082";
        NSString * const BASE_URL = @"http://pool-74-102-213-44.nwrknj.fios.verizon.net:8082/api/v1/";
    #endif
...
NSString * const LOCATION_DISABLED_ANCHOR = @"#locationdisabled";
NSString * const LOCATION_DENIED_ANCHOR = @"#locationdenied";
NSString * const LOCATION_RESTRICTED_ANCHOR = @"#locationrestricted";
NSString * const PUSH_DISALLOWED_ANCHOR = @"#pushdisallowed";
...
double const LOCATION_MAXIMUM_ACCEPTABLE_ERROR = 200.0; // Horizontal accuracy we're looking for
...
NSString * const FY_PROMPTED_TO_SEND_ARRIVAL_SMS = @"Prompted to Send Arrival SMS";
NSString * const FY_NOTIFIED_TO_SEND_ARRIVAL_SMS = @"Notified to Send Arrival SMS";
NSString * const FY_IGNORED_ARRIVAL_SMS_PROMPT = @"Ignored Prompt to Send Arrival SMS";
